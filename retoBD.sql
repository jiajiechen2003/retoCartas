...
CREATE TABLE IF NOT EXISTS grupos (
    ...
    INSERT INTO GRUPOS (grupo) VALUES ('Donquixote Pirates');
...
CREATE TABLE if not exists cartas (
    ...
    ('Roronoa Zoro', 6000, 2, 2, 1, 15, 'img/zoroLeader.jpg'), ('Sanji', 5000, 4, 2, 1, NULL,'img/sanjiLeader.jpg'), ('Trafalgar Law', 7000, 2, 2, 2, 15, 'img/lawLeader.png'),
    ...
    ('Jewelry Bonney', 1000, 3, 1, 14, 15, 'img/bonney.jpeg'), ('Shanks', 10000, 2, 2, 5, 6, 'img/shanksLeader.jpg'), ('Edward Newgate', 10000, 3, 2, 5, 7, 'img/barbablancaLeader.jpg'),
    ('Gol D. Roger', 10000, 2, 2, 8, NULL,'img/rogerLeader.jpg'), ('Monkey D. Garp', 7000, 2, 2, 9, NULL,'img/garpLeader.jpg'), ('Marshal D. Teach', 6000, 3, 2, 5, 10, 'img/barbanegraLeader.jpg'),
